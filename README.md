...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/npcslayer-img-create)
...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/npcslayer-img-create
```

A live public deployment of this template is available at [https://npcslayer-img-create.templates.workers.dev](https://npcslayer-img-create.templates.workers.dev)
